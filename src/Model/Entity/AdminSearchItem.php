 ...
 */
class AdminSearchItem extends AppEntity
{
    public const TYPE_USER_LIST = 1;
    public const TYPE_RESERVATION_LIST = 2;
    public const TYPE_MAIL_DELIVERIES = 3;
    public const TYPE_RESERVATION_USER = 4;

    public const ITEM_USER_ID = -1;
    public const ITEM_GUEST_FLG = -2;
    public const ITEM_WITHDRAWAL_FLG = -3;
    public const ITEM_RESERVATION_ID = -4;
    public const ITEM_EVENT_ID = -5;
    public const ITEM_RESERVATION_STATUS_ID = -6;
    public const ITEM_USAGE_TIMESTAMP = -7;
    public const ITEM_PAYMENT_METHOD = -8;
    public const ITEM_PAYMENT_STATUS = -9;
    public const ITEM_USER_INS_TIMESTAMP = -10;
    public const ITEM_RESERVATION_INS_TIMESTAMP = -11;
    public const ITEM_RESERVATION_VIDEO_METTING = -12;
    public const ITEM_RECEPTION_STATUS_ID = -13;
    public const ITEM_RESERVATION_PAYMENT_STATUS = -14;
    public const ITEM_RESERVATION_SMARTLOCK_STATUS = -15;
