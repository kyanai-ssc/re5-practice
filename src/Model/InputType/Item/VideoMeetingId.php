...
/**
 * VideoMeetingId class.
 */
class VideoMeetingId extends AbstractInputTypeItem implements CsvOutputInterface, MailOutputInterface
{
    use CsvOutputTrait;
    use MailOutputTrait;
    ...
    public function getDetailValue(?array $options = null)
    {
        ...
        return $videoMeeting['video_meeting_id'];
    }
