...
/**
 * RegistrationDeadline class.
 */
class RegistrationDeadline extends AbstractInputTypeItem implements MailOutputInterface
{
    use MailOutputTrait;
    ...
    public function getDetailValue(?array $options = null)
    {
        ...
        $value = $this->getOutputText(
            $event->get('registration_deadline_type'),
            $event->get('registration_deadline_number'),
            $event->get('registration_deadline_time'),
            $event->isRegistrationDeadlineCriterionTo()
        );
    ...
    {
        return 'event_registration_deadline';
    }
    ...
    public function getMailOutputValue(array $data, ?array $options = null)
    {
        ...
        $value = $this->getOutputText(
            $event['registration_deadline_type'],
            $event['registration_deadline_number'],
            $event['registration_deadline_time'],
            (string)$event['registration_deadline_criterion'] === (string)Event::CRITERION_TO
        );
