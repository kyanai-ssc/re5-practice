...
/**
 * VideoMeetingType class.
 */
class VideoMeetingType extends AbstractInputTypeItem implements CsvOutputInterface, MailOutputInterface
{
    use CsvOutputTrait;
    use MailOutputTrait;
    ...
    public function getDetailValue(?array $options = null)
    {
        ...
        return Configure::read('Master.organizer.videoMeetingType.' . $videoMeeting['video_meeting_type']);
    }
    ...
    public function getCsvOutputValue(?array $options = null)
    {
        ...
        $value = $this->csvFormat()->csvForId(
            $videoMeeting['video_meeting_type'],
            Configure::read('Master.organizer.videoMeetingType.' . $videoMeeting['video_meeting_type'], '')
        );
