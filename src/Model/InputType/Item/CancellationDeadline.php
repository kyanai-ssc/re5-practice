 ...
 */
class CancellationDeadline extends AbstractInputTypeItem implements MailOutputInterface
{
    use MailOutputTrait;
    ...
    public function getDetailValue(?array $options = null)
    {
        ...
        $value = $this->getOutputText(
            $event->get('cancellation_deadline_type'),
            $event->get('cancellation_deadline_number'),
            $event->get('cancellation_deadline_time'),
            $event->isCancellationDeadlineCriterionTo()
        );
    ...
    {
        return 'event_cancellation_deadline';
    }
    ...
    public function getMailOutputValue(array $data, ?array $options = null)
    {
        ...
        $value = $this->getOutputText(
            $event['cancellation_deadline_type'],
            $event['cancellation_deadline_number'],
            $event['cancellation_deadline_time'],
            (string)$event['cancellation_deadline_criterion'] === (string)Event::CRITERION_TO
        );
