...
return [
    ...
    'Error' => [
        ...
        'skipMail' => [
            'seconds' => 60,
            'messages' => [
                "max() [<a href='https://secure.php.net/function.max'>function.max</a>]: Array must contain at least one element",
