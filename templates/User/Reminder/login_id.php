<?php
$this->assign('title', $this->Tr->t('pageTitle/idReminder'));
$this->Breadcrumbs->add(
    $this->Tr->t('pageTitle/idReminder')
);
?>

<section class="contents-area l-remind">
    <h3 class="ttl-sec"><?= $this->Tr->t('pageTitle/idReminder') ?></h3>
    <?= $this->Form->create($reminderForm, [
        'type' => 'post',
        'url' => [
            'controller' => 'Reminder',
            'action' => 'loginId',
        ...
        'idPrefix' => 'id-reminder',
        'novalidate' => true,
        'class' => ['js_submit_once'],
    ]) ?>
    <?= $this->Flash->render('flash') ?>
    <fieldset class="input-remind mgb-40">
        <p class="mgb-10"><?= $this->Tr->nl2br('reminder/id/1') ?></p>
        <dl class="mgb-40">
