...
?>
RemoteLOCK連携で下記エラーになり、予約が行えませんでした。
下記の原因が考えられます。
・APIの利用制限に引っかかっている
・登録制限に引っかかっている
・デバイスキーの誤り
・アクセスゲストIDに紐づくアクセス権限のデータがすでに存在している

なお、RemoteLOCK側のアクセスゲストは連携成功しているため、
RemoteLOCK側のアクセスゲストを削除をお願いいたします。
...
アクセスゲストID: <?= $info['accessGuestId'] ?><?= PHP_EOL ?>
