<?php
$this->assign('title', '予約ステータス文言設定');
$this->assign('headerType', 'master');
$this->Breadcrumbs->add('予約ステータス文言設定');

$this->Html->script('admin/reservation-statuses/edit', [
    'block' => true,
]);
?>
...
<?= $this->Form->create(new ArrayObject(['words' => $words]), [
    ...
    'idPrefix' => 'status-words-edit',
    'novalidate' => true,
    'class' => ['js_submit_confirm'],
    'context' => ['table' => 'ReservationStatuses'],
